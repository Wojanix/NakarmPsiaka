...
const AboutUsScreen = () => {
  return (
    <Animated.View
      entering={BounceInUp}
      style={[styles.pagerView, { display: "flex", flexDirection: "column" }]}
    >
      <PagerView
        style={[styles.pagerView, { display: "flex", flexDirection: "column" }]}
      ...
      >
        ...
        >
          <Image source={paw} style={styles.imagePaw} resizeMode={"cover"} />
          <Image
            source={title}
        ...
        >
          ...
          <View style={styles.textSquare}>
            ...
            <Text style={styles.text}>
              Nasza aplikacja powstała z pragnienia pomocy - łączymy ludzi,
              którzy chcą poprawić los bezdomnych psów, kotów i innych zwierząt.
              Znajdźmy razem miejsca, gdzie pomoc jest najbardziej potrzebna, i
              sprawmy, że nasze zaangażowanie stanie się rzeczywistością dla
              tych bezbronnych istot.
            </Text>
          </View>
          <View style={styles.textSquare}>
            <Text style={styles.question}>Czemu kochamy zwierzęta?</Text>
            <Text style={styles.text}>
              Kochamy zwierzęta za ich lojalność i bezwarunkową miłość. Są
              nieocenionymi towarzyszami życia, dodającymi wartość i radość
